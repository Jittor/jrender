...
def main():
    ...
    render = Render(image_size=2048,camera_mode="look",eye=[-2.1,0.8,-3.6],camera_direction=[0.55,-0.05,1],near=0.5,viewing_angle=30)
    ...
    light3 = Light(position=[-3,4,0.3],direction=[3,-4, 0],intensity=1.2,type="point",shadow=False)
    ...
    writer = imageio.get_writer(os.path.join(args.output_dir, 'cow_with_ssr_debug.jpg'))
