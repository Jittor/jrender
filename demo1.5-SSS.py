...
def main():
    ...
    renderer = jr.Renderer(dr_type='softras',image_size=2048,light_intensity_ambient=0.45, light_color_ambient=[1,1,1],
    ...
    imsave(os.path.join(args.output_dir, 'head_sss.jpg'),image)
