...
class DrL_RasterizeFunction(Function):
    ...
    def execute(self, face_vertices, textures):
        ...
        self.save_vars = face_vertices, textures, soft_colors, points, faces_info, aggrs_info
        return soft_colors, points, msk

    def grad(self, grad_soft_colors, grad_points, grad_msk):

        face_vertices, textures, soft_colors, points, faces_info, aggrs_info = self.save_vars
        image_size = self.image_size
        background_color = self.background_color
        near = self.near
        far = self.far
