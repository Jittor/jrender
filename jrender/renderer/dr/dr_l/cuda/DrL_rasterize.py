...
def forward_DrL_rasterize(face_vertices, textures,
    ...
    return jt.code([faces_info.shape, aggrs_info.shape, soft_colors.shape, points.shape, msk.shape], [faces_info.dtype, aggrs_info.dtype, soft_colors.dtype, points.dtype, msk.dtype],
