...
from .DrL_rasterize import *

class DrL_Rasterizer(nn.Module):
    def __init__(self, image_size=256, background_color=[0, 0, 0], near=1, far=100, 
        ...
        super(DrL_Rasterizer, self).__init__()
    ...
    def execute(self, mesh, mode=None):
        ...
        images, points, msks = DrL_rasterize(mesh.face_vertices, mesh.face_textures, image_size, 
